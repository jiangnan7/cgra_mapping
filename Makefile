...
UTIL_OBJECTS := $(addprefix ./build/objects/, GraphSort.o NetworkAnalyzer.o FastMatcher.o NOrderValidator.o VanillaValidator.o Utils.o )
MAPPING_OBJECTS := $(addprefix ./build/objects/, FastPlace.o )
MODEL_OBJECTS = $(addprefix ./build/objects/,  FastRouter.o FastPlacer.o )
OBJECTS := $(COMMON_OBJECTS) $(UTIL_OBJECTS) $(MAPPING_OBJECTS) $(MODEL_OBJECTS)
# TEST_EXECS := $(addprefix ./build/, test0 test1)
SCRIPT_OBJECTS := $(addprefix ./build/,  place set)#pack partition
